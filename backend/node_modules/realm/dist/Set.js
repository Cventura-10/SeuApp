...
exports.createSetAccessor = exports.RealmSet = void 0;
...
class RealmSet extends internal_1.OrderedCollection {
    ...
    delete(value) {
        ...
        const [, success] = this.internal.removeAny(this[internal_1.COLLECTION_TYPE_HELPERS].toBinding(value));
        return success;
    }
    /**
     ...
     */
    add(value) {
        this[internal_1.COLLECTION_ACCESSOR].insert(this.internal, value);
        return this;
    }
    /**
