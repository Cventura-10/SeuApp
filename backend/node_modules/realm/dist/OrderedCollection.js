...
exports.createDefaultGetter = exports.OrderedCollection = void 0;
        ...
        if (typeof prop === "string") {
            ...
            if (Number.isInteger(index)) {
                ...
                try {
                    ...
                    if (index < 0 && !(target instanceof internal_1.Results)) {
...
class OrderedCollection extends internal_1.Collection {
    ...
    *entries() {
     ...
     */
    get type() {
        return (0, internal_1.getTypeName)((0, internal_1.toItemType)(this.results.type), undefined);
    }
    /**
    ...
    indexOf(searchElement, fromIndex) {
        ...
        if (this.type === "object") {
        ...
        else if ((0, internal_1.isJsOrRealmList)(searchElement) || (0, internal_1.isJsOrRealmDictionary)(searchElement)) {
            ...
            return this.results.indexOf(this[internal_1.COLLECTION_TYPE_HELPERS].toBinding(searchElement));
        }
    }
    /**
    ...
    filtered(queryString, ...args) {
        ...
        const itemType = (0, internal_1.toItemType)(results.type);
    ...
    snapshot() {
        ...
        const typeHelpers = this[internal_1.COLLECTION_TYPE_HELPERS];
        const accessor = (0, internal_1.createResultsAccessor)({ realm, typeHelpers, itemType });
        return new internal_1.Results(realm, snapshot, accessor, typeHelpers);
    }
    /** @internal */
