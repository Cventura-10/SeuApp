...
import React, { createContext, useRef, useState, useLayoutEffect, useContext, useReducer, useEffect, useMemo, useCallback } from 'react';
...
function createUseQuery(useRealm) {
    ...
    return function useQueryOverload(typeOrOptions, queryOrDeps = identity, deps = []) {
