 ...
 */
export declare const RealmProvider: React.FC<Omit<Partial<Realm.Configuration>, "sync"> & {
    sync?: Partial<Realm.SyncConfiguration> | undefined;
} & {
    fallback?: React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ComponentType<unknown> | null | undefined;
    closeOnUnmount?: boolean | undefined;
    realmRef?: React.MutableRefObject<Realm | null> | undefined;
